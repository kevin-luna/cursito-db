...
CREATE TABLE worker (
    ...
    "role" SMALLINT NOT NULL, -- 0 = docente, 1 = jefe de departamento
...
CREATE TABLE course (
    ...
    "type" SMALLINT NOT NULL, -- 0 = diplomado, 1 = taller
    "mode" SMALLINT NOT NULL, -- 0 = virtual, 1 = presencial
    "profile" SMALLINT NOT NULL, -- 0 = formacion, 1 = actualización docente
    goal TEXT NOT NULL,
    details TEXT,
...
CREATE TABLE attendances (
    ...
    CONSTRAINT fk_course
        FOREIGN KEY(course_id) 
        REFERENCES course(id),
    UNIQUE(worker_id, course_id, "date") -- Solo un registro de asistencia por día por trabajador por curso
);

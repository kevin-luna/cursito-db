...
CREATE TABLE worker (
    ...
    `role` TINYINT NOT NULL, -- 0 = docente, 1 = jefe de departamento
...
CREATE TABLE course (
    ...
    `type` TINYINT NOT NULL, -- 0 = diplomado, 1 = taller
    `mode` TINYINT NOT NULL, -- 0 = virtual, 1 = presencial
    `profile` TINYINT NOT NULL, -- 0 = formacion, 1 = actualización docente
    goal TEXT NOT NULL,
    details TEXT,
